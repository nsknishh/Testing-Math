...
public class MathTest{
    ...
    public void testReciprocal(double base, double exponent) {
        ...
        double test = Math.pow(base,-exponent);
        double test2 = 1.0 / Math.pow(base,1/exponent);
        assertEquals(
                test,test2,0.00001
        );
    ...
    public void testMultiplying(double base, double a, double b) {
        double one = Math.pow(base,a) * Math.pow(base,b);
        double two = Math.pow(base, a+b);
